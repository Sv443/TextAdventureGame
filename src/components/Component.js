...
class Component {
    /**
     * 
     * @param {("item"|"structure"|"effect")} type The type of the component. This determ
     * @param {String} objectName 
     * @returns {Component|String} Returns the constructed object, or, if an error was encountered, returns the error message as a string
     */
